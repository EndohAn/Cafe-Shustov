    ...
    <div>
        <div className="cart-box">
            <div className="cart-image-wrapper">
                <img className='cart-image' src = {cartItem.img} alt ="dish"/>
            ...
            <div className="cart-inner">
                ...
                <button className="quantity-btn " onClick={ () => dispatch(decrementQuantityInCart ( {cartItemId: cartItem.id} )) } > 
                    <img className="symbol" src= {process.env.PUBLIC_URL + "minus.png"}  alt="minus" />
                </button>
                ...
                <button className="quantity-btn" onClick={ () => dispatch(incrementQuantityInCart ( {cartItemId: cartItem.id}))}>
                    <img className="symbol" src= {process.env.PUBLIC_URL + "plus.png"}  alt="plus" />
                </button>
            </div>
            </div>
